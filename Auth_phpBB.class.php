 ...
 *
 * Rewritten for AuthManager and MediaWiki 1.26.0+
 *
 ...
 *
 */
class Auth_phpBB extends Mediawiki\Session\SessionProvider
{
  /**
   ...
   *
   */
  protected function isMemberOfWikiGroup($username)
  {
   ...
   *
   */
  protected function loadPHPFiles($FileSet)
  {
   ...
   * @access public
   */
  protected function mySQLError( $message )
  {
   ...
   * @return string
   */
  protected function utf8($username)
  {
